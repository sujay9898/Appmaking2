    ...
    <div className="min-h-screen bg-[#090708] pb-24 page-transition">
      ...
      <div className="cred-container cred-section pt-[49px] pb-[49px] text-[18px] font-normal">
        ...
        <div className="space-y-8 cred-slide-up">
          {posts.map((post) => (
            <Card key={post.id} className="cred-card-premium group relative ml-[12px] mr-[12px]">
              <CardContent className="cred-spacing-md cred-spacing-md pt-0 cred-spacing-lg text-left mt-[0px] mb-[0px] pl-[47px] pr-[47px] relative ml-[16px] mr-[16px]">
