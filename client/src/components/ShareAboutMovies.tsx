  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6">
      ...
      <div className="text-center mb-6">
        <h2 className="text-2xl font-bold text-white mb-2">Share About Movies</h2>
        <p className="text-gray-300 text-sm">Share your thoughts and discover what others are saying about movies</p>
      </div>
